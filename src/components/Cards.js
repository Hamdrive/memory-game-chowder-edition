...
const Cards = () => {
    ...
    const char1 = Math.floor(Math.random() * 10);
    const char2 = Math.floor(Math.random() * 10);
    const char3 = Math.floor(Math.random() * 10);
